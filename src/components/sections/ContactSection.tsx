        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="glass-morphism p-8 rounded-3xl border border-gray-200 flex items-center space-x-6 hover:border-blue-600 transition-all group cursor-pointer">
                    ...
                    <div>
                        <h4 className="text-xl font-bold">GRUOP WEB</h4>
                        <p className="text-sm text-gray-600 mb-3">Update Loading...</p>
                        <a href="#" className="inline-block px-4 py-2 bg-blue-700 rounded-lg text-xs font-bold uppercase hover:bg-blue-800 transition-colors">Vào Group</a>
                    </div>
                </div>
            </div>
